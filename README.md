...
(Первая лабораторная работа третьего семестра ИТМО)

Объектная модель симулятора транспортного маршрута поездов, с использованием основных принципов ООП.
...
- Реализация должна соответствовать основным принципам ООП, вы должны корректно инкапсулировать логику и сокрывать
